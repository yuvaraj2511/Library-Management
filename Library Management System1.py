...
root.iconbitmap('D:\Icon\iron.ico')
state1='disabled'
state2='disabled'
state3='disabled'
allRoll = [] 
...
def Menu():
    ...
    global state1,state2,btn1,btn2,btn3,btn4,btn5,btn6
    
   
    btn1 = Button(moduleFrame,text="Add Book Details",font=("arial",12,'bold'), bg='black',fg='blue',compound = LEFT, command=addBooks, state=state1)
    btn1.place(relx=0,rely=0.17, relwidth=1,relheight=0.12)
    
   
    btn2 = Button(moduleFrame,text="Delete Book",font=("arial",12,'bold'), bg='black',fg='blue', compound= LEFT, command=delete,state=state1)
    btn2.place(relx=0,rely=0.31, relwidth=1,relheight=0.12)
    
    
    btn3 = Button(moduleFrame,text="View Book List",font=("arial",12,'bold'), bg='black',fg='blue', compound= LEFT, command=View,state=state2)
    btn3.place(relx=0, rely=0.44, relwidth=1,relheight=0.12)
    
    
    btn4 = Button(moduleFrame,text="Search Book",font=("arial",12,'bold'), bg='black',fg='blue', compound= LEFT, command=searchBook,state=state2)
    btn4.place(relx=0,rely=0.58, relwidth=1,relheight=0.12)
    
    
    btn5 = Button(moduleFrame,text="Issue Book to Student",font=("arial",12,'bold'), bg='black',fg='blue', compound = LEFT, command = issueBook,state=state1)
    btn5.place(relx=0,rely=0.72, relwidth=1,relheight=0.12)
    
    
    btn6 = Button(moduleFrame, text="Return Book",font=("arial",12,'bold'), bg='black',fg='blue', compound = LEFT, command=ReturnBook,state=state1)
    btn6.place(relx=0,rely=0.86, relwidth=1,relheight=0.12)

    logoutBtn=Button(headingFrame, text="LOGOUT", font=('arial',10,'bold'), bg='black',fg='blue', command=logout, state=state3)
...
def addBooks(): 
    ...
    lb=Label(displayFrame,text='Add Book Details',font=("Times New Roman",26,'bold'),bg='black',fg='red')
    lb.place(relx=0.34,rely=0)

    
    lb1 = Label(displayFrame,text="Book ID : ",font=("arial",12,'bold'),bg='black',fg='red')
    lb1.place(relx=0.05,rely=0.2)
        
    en1 = Entry(displayFrame,font=("arial",12,'bold'),bg='green')
    en1.place(relx=0.3,rely=0.2, relwidth=0.62)
        
    
    lb2 = Label(displayFrame,text="Title : ",font=("arial",12,'bold'),bg='black',fg='red')
    lb2.place(relx=0.09,rely=0.35)
        
    en2 = Entry(displayFrame,font=("arial",12,'bold'),bg='green')
    en2.place(relx=0.3,rely=0.35, relwidth=0.62)
        
    
    lb3 = Label(displayFrame,text="Subject :",font=("arial",12,'bold'),bg='black',fg='red')
    lb3.place(relx=0.05,rely=0.5)
        
    en3 = Entry(displayFrame, font=("arial",12,'bold'), bg='green')
    en3.place(relx=0.3,rely=0.5, relwidth=0.62)
        
    
    lb4 = Label(displayFrame,text="Author : ",font=("arial",12,'bold'),bg='black',fg='red')
    lb4.place(relx=0.05,rely=0.65)
        
    en4 = Entry(displayFrame,font=("arial",12,'bold'), bg='green')
    en4.place(relx=0.3,rely=0.65, relwidth=0.62)
        
    
    SubmitBtn = Button(displayFrame,text="SUBMIT",font=("arial",12,'bold'),bg='black',fg='blue',command=bookRegister)
...
def delete(): 
    ...
    lb = Label(displayFrame,text='Delete Book',font=("Times New Roman",26,'bold'),bg='black',fg='red')
    ...
    SubmitBtn = Button(displayFrame,text="SUBMIT", font=("arial",12,'bold'),bg='black',fg='blue',command=deleteBook)
...
def issueBook(): 
    ...
    lb = Label(displayFrame,text="Issue Book to Student", font=('Times New Roman',26,'bold'), bg='black',fg='red')
    ...
    lb2 = Label(displayFrame,text="Issued To(Student Unique ID) : ",font=('arial', 12,'bold'),bg='black',fg='red')
    ...
    lb3 = Label(displayFrame,text="Issued By(Admin Unique ID) : ",font=('arial', 12,'bold'), bg='black',fg='red')
    ...
    issueBtn = Button(displayFrame,text="Issue",bg='black',fg='blue',font=("arial",12,'bold'), command=issue)
    issueBtn.place(relx=0.7,rely=0.75, relwidth=0.18,relheight=0.08)
    
    
    issuedBooks= Button(displayFrame,text="View Issued Books",bg='black',fg='blue',font=("arial",12,'bold'), command=displayissuedbooks)
...
def ReturnBook(): 
    ...
    headingLabel = Label(displayFrame, text="RETURN BOOK",font=('Times New Roman',26,'bold'),bg='black',fg='red')
    ...
    lb2 = Label(displayFrame,text="Student ID : ",font=('arial',12,'bold'),bg='black',fg='red')
    ...
    ReturnBtn = Button(displayFrame,text="Return",font=('arial',12,'bold'),bg='black',fg='blue',command=Return)
...
def searchBook(): 
    ...
    headingLabel = Label(displayFrame, text="Search Book",font=("Times New Roman",26,'bold'), bg='black',fg='red')
    headingLabel.place(relx=0.35,rely=0.05)   
        
    
    lb1 = Label(displayFrame,text="Enter Subject : ",font=("arial",12,'bold'), bg='black',fg='red')
    ...
    SearchBtn = Button(displayFrame,text="Search",font=('arial',12,'bold'),bg='black',fg='blue',command=search)
...
heading=Label(headingFrame,font=('Times New ROman', 40, 'bold'), text="Library Management System", bg='black',fg='red')
...
headingLabel = Label(moduleFrame, text="MENU",font=("Times New Roman",26,'bold'),bg='black',fg='red')
...
displayFrame=Frame(dFrame, bd=10, relief=SOLID, bg='black')
displayFrame.place(relx=0.2,rely=0.05, relwidth=0.6, relheight=0.9)


lb1=Label(headingFrame,text='Unique ID:',font=('arial', 12,'bold'), bg='black',fg='red')
...
lb2=Label(headingFrame,text='Name:',font=('arial', 12,'bold'), bg='black',fg='red')
...
lb3=Label(headingFrame,text='Password:',font=('arial', 12,'bold'), bg='black',fg='red')
...
lb4=Label(headingFrame,text='Role:',font=('arial', 12,'bold'), bg='black',fg='red')
...
loginBtn = Button(headingFrame,text="LOGIN", font=("arial",10,'bold'), bg='black',fg='blue',command=gettingLoginDetails)
loginBtn.place(relx=0.87,rely=0.4, relwidth=0.1)

regBtn=Button(headingFrame,text="REGISTER", font=("arial",10,'bold'), bg='black',fg='blue',command=gettingDetails)
